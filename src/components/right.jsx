...
export default function Right() {
    return(
        <>
            <div className="text-white flex flex-col  space-y-8 px-8 gap-y-24 bg-[#0f1f24] h-full">
               <div className="flex items-center justify-center flex-col mt-20 space-y-12"> 
